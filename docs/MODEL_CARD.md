...
- Interpretable roster-compatibility interactions are available only for conditional scenarios. Their validation ablation did not improve the additive hybrid, so they are not used by the simulator.
